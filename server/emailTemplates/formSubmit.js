                                                            ...
                                                            <tr>
                                                                <td class="pad">
                                                                    <div style="color:#101112;direction:ltr;font-family:Arial, Helvetica, sans-serif;font-size:16px;font-weight:400;letter-spacing:0px;line-height:120%;text-align:left;mso-line-height-alt:19.2px;">
                                                                        ...
                                                                        <p style="margin: 0; margin-bottom: 16px;"><strong>Thank you for showing interest in our company.</strong></p>
                                                                        <p style="margin: 0; margin-bottom: 16px;">Our team members will verify your submitted form details.</p>
                                                                        <p style="margin: 0; margin-bottom: 16px;">Then we'll notify with the next procedure.</p>
