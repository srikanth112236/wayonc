...
const CheckOutShowMore = () => {
              ...
              axios
                ...
                .then((result) => {
                  if (result.data.Status === 'Success') {
                    ...
                    if (result.data.result.checkout === true) {
                      setCheckOut(true);
                    } else {
                      setCheckOut(false);
                    }
  ...
  const handleCheckout = async () => {
    ...
    await axios
      ...
      .then((result) => {
        if (result.data.Status === 'Success') {
          alert('Paid and deactivated there account');
                    ...
                    <Container>
                      ...
                      {checkOut && (
                        ...
                        >
                          <Table.Header>
                            <Table.Column>INVESTMENT</Table.Column>
                            <Table.Column>RETURNING AMOUNT</Table.Column>
                            <Table.Column>PAY CHECKOUT AMOUNT</Table.Column>
                          </Table.Header>
                          <Table.Body>
                            <Table.Row>
                              <Table.Cell>{userData.plan.principal}</Table.Cell>
                              <Table.Cell>{userData.checkoutMoney}</Table.Cell>
                              <Table.Cell>
                                <button
                                  className="pay"
